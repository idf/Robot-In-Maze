...
Eyes* eyes = new Eyes(Pin::ULTRA_1_PWM, Pin::ULTRA_1_TRIG, Pin::ULTRA_2_PWM, Pin::ULTRA_2_TRIG, Pin::FRONT_IR_LEFT, Pin::FRONT_IR_RIGHT, Pin::CENTER_IR, Pin::SIDED_RIGHT_IR, Pin::SIDED_LEFT_IR);
